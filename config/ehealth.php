...
// It merges arrays without creating numeric indexes for duplicate string keys.
...
// Base roles scopes that can be extended
$doctorScopes = [
    'declaration:read', 'declaration_request:approve', 'declaration_request:read', 'declaration_request:sign',
    'declaration_request:write', 'division:read', 'employee:read', 'employee_request:approve', 'employee_request:reject',
    'employee_request:read', 'legal_entity:read', 'otp:read', 'otp:write', 'person:read', 'person_emergency_contact:read',
    'patient_summary:read', 'encounter:write', 'encounter:read', 'encounter:cancel', 'episode:write', 'episode:read',
    'job:read', 'condition:read', 'condition:write', 'observation:read', 'observation:write', 'immunization:read',
    'immunization:write', 'allergy_intolerance:read', 'allergy_intolerance:write', 'medication_statement:read',
    'medication_statement:write', 'device:read', 'device:write', 'risk_assessment:read', 'risk_assessment:write',
    'medication_dispense:read', 'drugs:read', 'medication_request:details', 'medication_request:read',
    'medication_request:reject', 'medication_request:resend', 'medication_request_request:read',
    'medication_request_request:reject', 'medication_request_request:sign', 'medication_request_request:write',
    'diagnostic_report:read', 'diagnostic_report:write', 'diagnostic_report:cancel', 'procedure:read', 'procedure:write',
    'procedure:cancel', 'service_request:makeinprogress', 'service_request:complete', 'service_request:recall',
    ...
    'employee_role:read', 'person_request:write', 'person_request:read', 'authentication_method_request:write',
    'care_plan:write', 'care_plan:read', 'approval:read', 'approval:cancel', 'composition:create', 'composition:sign',
    'composition:cancel', 'composition:read', 'composition:write', 'composition:search', 'composition:resend_sms',
    'composition:mark_in_error', 'composition_configuration:read', 'confidant_person_relationship:read',
    'confidant_person_relationship_request:write', 'confidant_person_relationship_request:read', 'license:read',
    'clinical_impression:read', 'clinical_impression:write', 'rule_engine_rule:read', 'medical_event_context:read',
    'person_verification:details', 'person_verification:write', 'person_verification:read', 'personal_data:read',
    'device_definition:read', 'device_request:write', 'device_request:read', 'device_request:resend',
    'device_request:revoke', 'specimen:write', 'specimen:read', 'specimen:process', 'specimen:cancel',
    'specimen:reject', 'specimen:invalidate', 'device_request:mark_in_error', 'device_request:complete',
    'device_dispense:read', 'device_association:read', 'detected_issue:read', 'preperson:read', 'preperson:write',
];

$specialistScopes = $doctorScopes; // Specialist has all doctor's scopes + merge requests

$specialistScopes = array_values(array_unique(array_merge($specialistScopes, [
    'merge_request:sign',
])));

$ownerScopes = [
    'capitation_report:read', 'client:read', 'connection:delete', 'connection:read', 'connection:refresh_secret',
    'connection:write', 'declaration:read', 'declaration_request:approve', 'declaration_request:read',
    'declaration_request:reject', 'declaration_request:write', 'division:activate', 'division:deactivate',
    'division:details', 'division:read', 'division:write', 'employee:deactivate', 'employee:details',
    'employee:read', 'employee:write', 'employee_request:approve', 'employee_request:read', 'employee_request:reject',
    'employee_request:write', 'legal_entity:read', 'otp:read', 'otp:write', 'person:read', 'person_verification:details',
    'reimbursement_report:read', 'related_legal_entities:read', 'secret:refresh', 'healthcare_service:read',
    'healthcare_service:write', 'employee_role:read', 'employee_role:write', 'license:details', 'license:read',
    'license:write', 'rule_engine_rule:read', 'party_verification:details', 'party_verification:write',
];

$contractScopes = [
    'contract:read', 'contract:write', 'contract_request:approve', 'contract_request:create',
    'contract_request:read', 'contract_request:sign', 'contract_request:terminate',
];

// Combine owner scopes with contract scopes for specialized care
$ownerWithContractsScopes = array_values(array_unique(array_merge($ownerScopes, $contractScopes)));
...
$config = [
    ...
    'employee_type' => [
        ...
        'PHARMACY_OWNER' => [
            'position' => [
                'P1', 'P2', 'P3', 'P4', 'P5', 'P6', 'P18', 'P19', 'P22', 'P23', 'P24', 'P25', 'P26', 'P32',
        ...
        'PHARMACIST' => [
            'position' => [
                'P16', 'P19', 'P20', 'P21', 'P217', 'P218', 'P219', 'P220', 'P221', 'P222', 'P223', 'P259',
                'P260', 'P261', 'P262', 'P263', 'P264', 'P265',
            ],
            'speciality_type' => [
                'PHARMACEUTICS_ORGANIZATION', 'PROVISOR', 'ANALYTICAL_AND_CONTROL_PHARMACY',
        ...
        'ASSISTANT' => [
            'position' => [
                'P17', 'P66', 'P169', 'P170', 'P171', 'P173', 'P174', 'P175', 'P176', 'P177', 'P178', 'P179',
            ...
            'speciality_type' => [
                'ORTHOPEDIC_DENTISTRY', 'X_RAY_RADIOLOGY', 'SANOLOGY', 'STOMATOLOGY',
            ...
            'qualification_type' => [
                'CLINICAL_RESIDENCY', 'INTERNSHIP', 'REATTESTATION', 'SPECIALIZATION',
        ...
        'LABORANT' => [
            'position' => [
                'P17', 'P170', 'P173', 'P241', 'P242', 'P243', 'P244', 'P251', 'P256', 'P271', 'P272',
                'P273', 'P274', 'P276', 'P277', 'P278', 'P279', 'P281',
            ],
            'speciality_type' => [
                'VIROLOGY', 'MICROBIOLOGY', 'LABORATORY_GENETICS', 'LABORATORY_IMMUNOLOGY',
            ...
            'qualification_type' => [
                'REATTESTATION', 'SPECIALIZATION', 'CLINICAL_RESIDENCY', 'INTERNSHIP',
                'STAZHUVANNYA', 'POSTGRADUATE', 'TOPIC_IMPROVEMENT',
            ],
        ...
        'SPECIALIST' => [
            'position' => [
                'P5', 'P6', 'P8', 'P9', 'P10', 'P11', 'P12', 'P13', 'P33', 'P34', 'P35', 'P36', 'P37', 'P38',
        ...
        'MED_ADMIN' => [
            'position' => [
                'P1', 'P2', 'P3', 'P4', 'P5', 'P6', 'P23', 'P24', 'P25', 'P26', 'P32', 'P229',
                'P230', 'P231', 'P249', 'P257',
            ],
        ],
    ],
    ...
    'scopes_by_legal_entity_type' => [
        'PRIMARY_CARE' => [
            'OWNER' => $ownerScopes,
            'DOCTOR' => $doctorScopes,
            // Add other roles for PRIMARY_CARE if needed
        ],
        'OUTPATIENT' => [
            'OWNER' => $ownerWithContractsScopes,
            'SPECIALIST' => $specialistScopes,
            // Add other roles for OUTPATIENT if needed
        ],
        'EMERGENCY' => [
            'OWNER' => $ownerWithContractsScopes,
            'SPECIALIST' => $specialistScopes,
            // Add other roles for EMERGENCY if needed
        ],
        'PHARMACY' => [
            'PHARMACY_OWNER' => [
                'employee_role:write', 'employee_role:read', 'healthcare_service:write', 'healthcare_service:read',
                'division:activate', 'division:deactivate', 'division:details', 'division:read', 'division:write',
                'employee:deactivate', 'employee:details', 'employee:read', 'employee:write', 'employee_request:approve',
                'employee_request:read', 'employee_request:reject', 'employee_request:write', 'legal_entity:read',
                'otp:read', 'otp:write', 'secret:refresh', 'client:read', 'connection:read', 'connection:write',
                'connection:refresh_secret', 'connection:delete', 'contract_request:create', 'contract_request:read',
                'contract_request:terminate', 'contract_request:approve', 'contract_request:sign', 'contract:read',
                'contract:write', 'medical_program_provision:write', 'medical_program_provision:read', 'license:details',
                'license:read', 'license:write', 'medication_dispense:read_pharm', 'medication_request:details_pharm',
            ...
            'PHARMACIST' => [
                ...
                'employee_request:read', 'legal_entity:read', 'medication_dispense:process', 'medication_dispense:write',
                'medication_dispense:reject', 'healthcare_service:read', 'employee_role:read', 'license:read',
                'medication_request:details_pharm', 'medication_request:reject_pharm', 'medication_dispense:read_pharm',
                'party_verification:details', 'party_verification:write', 'device_dispense:write', 'device_dispense:read',
                'device_dispense:stop', 'device_request:read', 'device_dispense:complete', 'device_request:complete',
                'device_dispense:mark_in_error', 'medication_request:block_pharm', 'medication_request:unblock_pharm',
            ],
        ],
    ],
...
// For backward compatibility, we create the old 'roles' structure by merging all scopes.
$legacyRoles = [];
foreach ($config['scopes_by_legal_entity_type'] as $type => $roles) {
    $legacyRoles = array_merge_recursive_distinct($legacyRoles, $roles);
}
// Ensure all values are unique strings
foreach ($legacyRoles as $roleName => $scopes) {
    $legacyRoles[$roleName] = array_values(array_unique($scopes));
}

$config['roles'] = $legacyRoles;
